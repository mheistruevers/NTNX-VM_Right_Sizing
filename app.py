...
with header_section:
    ...
    st.markdown('Ein Hobby-Projekt von Martin Stenke & [**Michael Heistruevers**](https://www.linkedin.com/in/michael-heistruevers/) zur einfachen Analyse einer [**Nutanix Collector**](https://collector.nutanix.com/) Auswertung hinsichtlich VM Right Sizing Empfehlungen. (Zuletzt aktualisiert: 08.10.2024)')
